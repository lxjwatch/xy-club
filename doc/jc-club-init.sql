...
INSERT INTO `auth_user` (`id`, `user_name`, `nick_name`, `email`, `phone`, `password`, `sex`, `avatar`, `status`, `introduce`, `ext_json`, `created_by`, `created_time`, `update_by`, `update_time`, `is_deleted`) VALUES (21, 'oYA4Ht0hASL-driMQxyCKUSUsdkQ', '鸡翅粉丝', NULL, NULL, NULL, NULL, 'http://117.72.10.84:9000/user/icon/微信图片_20231203153718(1).png', 0, NULL, NULL, NULL, NULL, NULL, NULL, 0);
COMMIT;
